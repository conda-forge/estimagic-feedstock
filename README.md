...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/estimagic-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14638&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/estimagic-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `estimagic` can be installed with:

```
conda install estimagic
```

It is possible to list all of the versions of `estimagic` available on your platform with:
